...
import com.example.crud_room_leo.databinding.ActivityMainBinding
import kotlinx.coroutines.launch

class MainActivity : AppCompatActivity(), AdaptadorListener {

    lateinit var binding: ActivityMainBinding
    var listUsuarios: MutableList<Usuario> = mutableListOf()
    ...
    fun obtenerUsuarios(room: DBPrueba){
        lifecycleScope.launch{
            listUsuarios = room.daoUsuario().obtenerUsuarios()
            adaptador = AdaptadorUsuarios(listUsuarios, this@MainActivity)
